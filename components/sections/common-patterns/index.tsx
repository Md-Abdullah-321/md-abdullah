  ...
  return (
    <section className="relative isolate overflow-hidden bg-surface-muted py-16 md:py-20 lg:py-24">
      ...
      <Container>
        ...
        <Reveal variant="section" className="mt-6 hidden md:block"><ProcessDesktop /></Reveal>
        <Reveal variant="section" className="mt-6 md:hidden"><ProcessMobile /></Reveal>
        <Reveal variant="section" className="mt-12 border-t border-border pt-8 md:mt-16 md:pt-10">
