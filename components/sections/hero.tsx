        ...
        <div className="relative grid items-start gap-9 lg:grid-cols-[minmax(0,1.05fr)_minmax(420px,0.95fr)] lg:gap-14 xl:gap-20">
          <div className="flex flex-col gap-6 lg:pt-6">
            <div className="flex flex-col gap-5">
              <Reveal variant="label" inView={false} delay={0} className="inline-flex items-center gap-3">
              ...
              <Reveal variant="body" inView={false} delay={0.16}>
                <p className="max-w-[50ch] font-sans text-[1.0625rem] leading-[1.62] text-muted-foreground sm:text-[1.125rem]">
                  I connect the tools your business already relies on, remove
                  the manual handoffs, and build workflows that keep your team
            ...
            <Reveal
              ...
              inView={false}
              delay={0.32}
              className="grid grid-cols-2 border-y border-border/80 sm:grid-cols-4"
            >
          ...
          <div className="relative lg:pt-1">
            ...
            <Reveal variant="body" inView={false} delay={0.28}>
              <p className="mt-3 max-w-xs text-xs leading-relaxed text-muted-foreground">
                A quick look at how I think about systems, handoffs, and the
          ...
          <Reveal
            ...
            inView={false}
            delay={0.4}
            className="mt-0 border-t border-border/40 pt-4 lg:col-span-2"
          >
